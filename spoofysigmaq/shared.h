...
typedef struct
{
	...
	SMBIOS_STRING   Manufacturer;
	SMBIOS_STRING   ProductName;
	SMBIOS_STRING   Version; //doesnt work for some reason? idek 
	SMBIOS_STRING   SerialNumber;
    SMBIOS_STRING AssetTag;
	int idk : 10;
	SMBIOS_STRING LocationWithinContainer; //this doesnt work either i think name is wrong
} SMBIOS_TYPE2;
